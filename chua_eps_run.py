...
from odelibrary import CHUA as ODE
import pandas as pd
import pdb
import pickle
import argparse
...
parser.add_argument('--output_dir', default='/groups/astuart/mlevine/ode_model_error/experiments/chuaeps_v5_eps_validateReg/', type=str)
...
def main(cmd_py, output_dir, cmd_job, datagen, conda_env, **kwargs):
    ...
    data_pathname = os.path.join(output_dir, 'chuadata.pickle')
    ...
    if datagen:
        generate_data(ode=ODE(), **datagen_settings)
