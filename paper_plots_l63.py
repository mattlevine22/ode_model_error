...
def plot_epsilon(base_dir, plot_dir):
    ...
    fig_path = os.path.join(plot_dir, 'eps_quality')

    new_summary(df=paper_df, fig_path=fig_path, x="f0eps", y='t_valid_005',
                xlabel='$\epsilon$',
...
def plot_dt(base_dir, plot_dir):
    ...
    fig_path = os.path.join(plot_dir, 'dt_quality')

    new_summary(df=paper_df, fig_path=fig_path, x="dt", y='t_valid_005',
                xlabel='$\Delta t$',
                ylabel='Validity Time',
...
def plot_T(base_dir, plot_dir):
    ...
    fig_path = os.path.join(plot_dir, 'T_quality')

    new_summary(df=paper_df, fig_path=fig_path, x="tTrain", y='t_valid_005',
...
def plot_rfDim(base_dir, plot_dir):
    ...
    new_summary(df=paper_df, fig_path=fig_path, x="rfDim", y='t_valid_005',
                xlabel='$D_r$',
                ylabel='Validity Time',
