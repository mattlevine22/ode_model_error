...
parser.add_argument('--output_dir', default='/groups/astuart/mlevine/ode_model_error/experiments/l63b1_WATERWHEEL_v5_rfDim_validateAll/', type=str)
...
def main(cmd_py, output_dir, cmd_job, datagen, conda_env, **kwargs):
    ...
    if datagen:
        generate_data(ode=L63(c=1), **datagen_settings)
