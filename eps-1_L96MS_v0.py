...
parser.add_argument('--output_dir', default='/groups/astuart/mlevine/ode_model_error/experiments/l96ms_eps-1_v0/', type=str)
...
def main(cmd_py, output_dir, cmd_job, datagen, conda_env, **kwargs):
    ...
    if datagen:
        generate_data(ode=L96M(eps=2**(-1)), **datagen_settings)
